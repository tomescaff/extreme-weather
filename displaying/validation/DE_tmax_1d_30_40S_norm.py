...
lens1 = 'DE_LENS1_tmax_1d_30_40S_all_estimate_nboot_1000_' +\
    'tau_100_norm_evaluation.csv'

filenames = [lens1, lens1, lens1, lens1, lens1]
...
fig, axs = plt.subplots(6, 1, figsize=(8, 7.5))

varnames = ['mu_pa', 'mu_ac', 'mu_fu', 'sig_pa', 'sig_ac', 'sig_fu']
xlabels = ['Location parameter - CF climate (ºC)',
           'Location parameter - AC climate (ºC)',
           'Location parameter - FU climate (ºC)',
           'Scale parameter - CF climate (ºC)',
           'Scale parameter - AC climate (ºC)',
           'Scale parameter - FU climate (ºC)']
xlims = [[35, 40], [35, 40], [35, 40], [0, 2], [0, 2], [0, 2]]
...
filename = 'DE_tmax_1d_30_40S_validation_nboot_1000_norm.png'

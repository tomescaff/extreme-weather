...
tlocal_cr = lens.lens1_tmax_1d_djf_30_40S_cr()
tglobal_cr = gmst.annual_lens1_cr()
...
Tac = tglobal_full.sel(time='2017').values
Tpa = tglobal_obs.sel(time='1880').values
Tfu = np.array([2.0])
...
x = gev.pdf(y, *gev.fit(tlocal_cr.values))
...
filename = 'LENS1_tmax_1d_GMST_gev_ext_dist_cr.png'
filepath = basedir + filename

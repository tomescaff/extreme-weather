...
t2m = xr.open_mfdataset(bdir + 'ERA5_t2m_6h_2023_*_Global_025deg-fldmax.nc')
t925 = xr.open_mfdataset(bdir + 'ERA5_t925_6h_2023_*_Global_025deg-fldmax.nc')
t750 = xr.open_mfdataset(bdir + 'ERA5_t750_6h_2023_*_Global_025deg-fldmax.nc')
t500 = xr.open_mfdataset(bdir + 'ERA5_t500_6h_2023_*_Global_025deg-fldmax.nc')
t300 = xr.open_mfdataset(bdir + 'ERA5_t300_6h_2023_*_Global_025deg-fldmax.nc')
...
plt.yticks(z, plev)
xticks = x[::8]
xlabels = [f'2023-{t.dt.month.values:02}-{t.dt.day.values:02}'
           for t in time[::8]]
...
filename = 'ERA5_theta_vertical_profile_2023.png'

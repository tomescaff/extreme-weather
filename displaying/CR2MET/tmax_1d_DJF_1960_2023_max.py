...
tmax = cr2met.tmax_1d_djf()
tmax_clim = tmax.max('time')
...
pcm = ax.pcolormesh(da.lon.values, da.lat.values, da.values,
                    cmap=cmaps.amwg_blueyellowred, zorder=4, vmin=25, vmax=45)
...
plt.savefig('/home/tcarrasco/result/images/png/CR2MET_tmax_1d_DJF.png',

...
month = '01'
day = '26'
da_day = cr2met.daily_tmax(year, month, day)
da_clim = cr2met.daily_clim_30d_nearest(year, month, day)

da = da_day - da_clim.values
...
pcm = ax.pcolormesh(da.lon.values, da.lat.values, da.values,
                    cmap=cmaps.amwg_blueyellowred, zorder=4, vmin=-16, vmax=16)
...
filename = f'CR2MET_tmax_{year}_{month}_{day}_30_45S_anom_30d_nearest.png'

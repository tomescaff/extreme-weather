...
year = '2017'
month = '01'
da_25 = cr2met.daily_tmax(year, month, '25')
da_26 = cr2met.daily_tmax(year, month, '26')
da_27 = cr2met.daily_tmax(year, month, '27')

lat = da_25.lat
lon = da_25.lon
time = pd.date_range('25-01-2017', '27-01-2017', freq='1D')
...
filename = f'CR2MET_tmax_event_2017_25_45S.png'

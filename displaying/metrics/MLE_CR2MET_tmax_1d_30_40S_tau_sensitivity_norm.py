...
def tau(yr_list, init_parm):
    ...
    return metrics.tau_best_estimate_norm(x, y, tglobal_2022, tlocal_2023,
                                          init_parm)
...
cr2met = 'MLE_CR2MET_tmax_1d_30_40S_nboot_1000_norm_evaluation.nc'
no2017 = 'MLE_CR2MET_tmax_1d_30_40S_nboot_1000_norm_no2017_evaluation.nc'
no2023 = 'MLE_CR2MET_tmax_1d_30_40S_nboot_1000_norm_no2023_evaluation.nc'
no2017_no2023 = 'MLE_CR2MET_tmax_1d_30_40S_nboot_1000_norm_' + \
...
models = [metrics.bootstrap_tau_norm(model, tglobal_2022, tlocal_2023)
          for model in models]
...
filename = 'MLE_tmax_1d_metrics_sensitivity_norm.png'

...
varnames = ['tau_ac', 'tau_fu', 'PR fu-ac', 'Delta fu-ac']
xlabels = ['Factual return period (yr)', 'Future return period (yr)',
           'Future probability ratio', 'Future intesity change (ºC)']
...
filename = 'MLE_tmax_1d_metrics_future_nboot_100.png'

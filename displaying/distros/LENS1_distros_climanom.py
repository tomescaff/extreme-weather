...
# compute histogram
hist, bins = np.histogram(data, bins=np.linspace(-10, 20, 80), density=True)
...
plt.bar(center, hist, align='center', width=width, edgecolor='#000000',
        facecolor='#65647C', alpha=0.7, lw=0.2, label='LENS1 Tmax anom (GEV)')
plt.xlim([-10, 20])
...
filename = 'LENS1_climanom_distros.png'

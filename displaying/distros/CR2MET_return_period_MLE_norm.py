...
x_rp = 1/dist.sf(y_rp, mu_act, sigma)
y_rp_dist = dist.isf(1/x_rp, mu_act, sigma)
...
filename = f'MLE_CR2MET_tmax_1d_30_40S_nboot_{nboot}' +\
    '_norm_no2017_no2023_evaluation.nc'
...
for i in range(nboot):
    bspreds[i, :] = 1/dist.sf(y_rp_dist, boot_mu[i], boot_sigma[i])
...
filename = 'CR2MET_return_period_MLE_norm.png'
filepath = basedir + filename

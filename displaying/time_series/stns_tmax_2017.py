...
cu = cu.sel(time=slice('2017-01-01', '2017-02-28'))
ch = ch.sel(time=slice('2017-01-01', '2017-02-28'))
te = te.sel(time=slice('2017-01-01', '2017-02-28'))
la = la.sel(time=slice('2017-01-01', '2017-02-28'))
...
c = '#86C8BC'
plt.sca(axs[2])
plt.plot(np.arange(cu.time.size), cu.values,
         marker='o', ms=3.8, lw=1.2, c=c, zorder=100)
plt.axhline(cu_enefeb, c=c, lw=0.6, ls='--')
plt.ylim([15, 45])
plt.xlim([-4, 60])
plt.xticks(np.arange(0, 65, 5))
plt.yticks([20, 30, 40])

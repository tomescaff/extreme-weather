...
ax.contourf(x, y, z, levels=30, cmap=cmaps.BlueYellowRed)
del_val = 10
ax.barbs(x[::del_val, ::del_val], y[::del_val, ::del_val], ug[::del_val,
         ::del_val], vg[::del_val, ::del_val], color='r', pivot='middle',
         length=4)
ax.barbs(x[::del_val, ::del_val], y[::del_val, ::del_val], u[::del_val,
         ::del_val], v[::del_val, ::del_val], color='k', pivot='middle',
         length=4)
plt.title('Z500, Wind (black), geosWind (red)')

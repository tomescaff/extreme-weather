...
idir="/home/tcarrasco/result/data/LENS2/tmax/orig/HISTFU/"
odir="/home/tcarrasco/result/data/LENS2/tmax/reduced/HISTFU/"
...
selend="-select,enddate=2100-04-01T00:00:00"
...
do
  ...
  opath="${odir}${oname}"
  cdo -L -O -z zip_9 $del1de $delmar $selmon $selend $selsta $selbox $selvar $file $opath
done
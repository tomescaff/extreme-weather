...
idir=/home/tcarrasco/result/data/LENS2/tmax/computed/EX/
odir=/home/tcarrasco/result/data/LENS2/tmax/final/

mkdir -p $odir

# set input and output filenames
iname_1d=LENS2.DJF.max.1d.TREFHTMX.*.nc
oname_1d=temp_1d.nc
oname_1d_degc=CESM2_LENS_tmax_1day_DJF_1851_2100_chile_1deg_100m.nc

iname_3d=LENS2.DJF.max.3d.TREFHTMX.*.nc
oname_3d=temp_3d.nc
oname_3d_degc=CESM2_LENS_tmax_3day_DJF_1851_2100_chile_1deg_100m.nc

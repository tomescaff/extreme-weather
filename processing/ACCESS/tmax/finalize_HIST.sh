...
idir=/home/tcarrasco/result/data/ACCESS/tmax/computed/HIST/
odir=/home/tcarrasco/result/data/ACCESS/tmax/final/

mkdir -p $odir

# set input and output filenames
iname_1d=ACCESS.DJF.max.1d.tasmax.*.nc
oname_1d=temp_1d.nc
oname_1d_degc=ACCESS_tmax_1day_DJF_1851_2014_chile_250km_40m.nc

...
filename = f'MLE_CR2MET_tmax_1d_30_40S_nboot_{nboot}_gev' +\
    '_evaluation.nc'
filepath = basedir + filename
model = xr.open_dataset(filepath)

df_out = metrics.MLE_all_estimate_gev(df, model, Tg_ac=1.1, tau=tau)

basedir = "/home/tcarrasco/result/data/all_estimate/"
filename = f'MLE_CR2MET_tmax_1d_30_40S_all_estimate' +\
    f'_nboot_{nboot}_tau_{tau}_gev_evaluation_extrapolation.csv'
filepath = basedir + filename

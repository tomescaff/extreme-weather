...
basedir = "/home/tcarrasco/result/data/best_estimate/"
filename = 'MLE_CR2MET_tmax_1d_30_40S_best_estimate_norm_no2017_evaluation.csv'
filepath = basedir + filename
df.to_csv(filepath)
...
basedir = "/home/tcarrasco/result/data/best_estimate/"
filename = 'MLE_CR2MET_tmax_1d_30_40S_best_estimate_norm_no2023_evaluation.csv'
filepath = basedir + filename
df.to_csv(filepath)
